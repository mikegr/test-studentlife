  ...
  members :
  {
    ...
    main : function()
    {
      ...
      */
      ...
      var logo = new qx.ui.basic.Image("studentlife/logo.png");
      ...
      var mycourses = new qx.ui.basic.Image("studentlife/mycourses.png");
      left.add(mycourses);
...
/*
      var seperator = new qx.ui.basic.Image("studentlife/columnborder.png");
      var hbox2 = new qx.ui.basic.Image("studentlife/columnborder.png");
...
*/
      ...
      var alsoAttending = new qx.ui.basic.Image("studentlife/alsoattending.png");
      right.setLayout(new qx.ui.layout.VBox());
      var hSeparator = new qx.ui.basic.Image("studentlife/columnborder.png");
      right.add(alsoAttending);
      
      this.addAlsoAttending(right, "studentlife/testprofilepic1.png", "Gustav Klimt", "http://orf.at", "also attending 3 equal courses", "http://orf.at");
      this.addAlsoAttending(right, "studentlife/testprofilepic2.png", "Gustav Klimt", "http://orf.at", "also attending 3 equal courses", "http://orf.at");

      main.add(left, {top:73, left:17});
      main.add(this.menuContainer(), {top:32, left:17});
      main.add(this.adContainer("studentlife/payedAD.png"), {top:445, left:195});
   ...
   addAlsoAttending : function (container, image, name, link, info, addLink) {	
	...
	margin:[0,4,0,1]
      ...
      var closeImage = new qx.ui.basic.Image("studentlife/cross.png").set({
	  padding:[0,0,0,0]
      });

      var hoverImage = new qx.ui.basic.Image("studentlife/cross-hover.png").set({
	  padding:[0,0,0,0]
      });
   ...
   menuContainer : function() {
      ...
      var agendaImage = new qx.ui.basic.Image("studentlife/menu-agenda.png").set({
	  padding:[3,0,0,4]
      });
      var menuImage = new qx.ui.basic.Image("studentlife/menu-courses.png").set({
	  padding:[3,0,0,19]
      });
      ...
      var courseSettingsImage = new qx.ui.basic.Image("studentlife/menu-coursesettings.png").set({
	padding:[4,0,0,0]
      });

      var menuVBorderImage = new qx.ui.basic.Image("studentlife/menu-vborder.png").set({
	padding:[1,6,0,6]
      });
